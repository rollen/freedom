...
CPPPATH_NODE = '/Users/rollen_gomes/opt/node/include/node'
CPPPATH_PG = ['/opt/local/include/postgresql90']
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/Users/rollen_gomes/.node_libraries'
LIBPATH_NODE = '/Users/rollen_gomes/opt/node/lib'
LIBPATH_PG = ['/opt/local/lib/postgresql90']
LIBPATH_ST = '-L%s'
LIB_PG = ['pq']
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/Users/rollen_gomes/.node_libraries'
PG_CONFIG = '/opt/local/lib/postgresql90/bin/pg_config'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/rollen_gomes/opt/node'
